...
STOP_WORD_PATH = '/home/shimeng.zhan/stopwords/stopwords.txt' # 停用词保存路径
#测评模块配置
...
# 核心类配置
SEGMENTOR_PATH = 'ltp_model/cws.model'  # 分词模型路径
PERSONAL_SEGMENTOR_PATH = 'Data/word.txt'  # 自定义词库路径
POSTAGGER_PATH = 'ltp_model/pos.model'  # 词性标注模型路径
NAMED_ENTITY_RECONGNTION_PATH = 'ltp_model/ner.model'   # 命名实体识别模型路径
PARSER_PATH = 'ltp_model/parser.model'  # 语法依存模型路径
LABELLER_PATH = 'ltp_model/pisrl.model'  # 语义角色模型路径
